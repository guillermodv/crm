...
import {ACCOUNTS, ADRESSCONTENT, CONTACTSCONTENT, EVENTS, NOTESCONTENT} from "../../const";
                ...
                <div className="card">
                    ...
                    <div id="collapseOne" className="collapse collapsed" aria-labelledby="headingOne"
                        ...
                        <div className="card-body">
                            <GenericsTable items={NOTESCONTENT} showDate={true}/>
                        </div>
                    </div>
                </div>
                <div className="card">
                    ...
                    <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div className="card-body">
                            <GenericsTable items={ADRESSCONTENT}/>
                        </div>
                    </div>
                </div>
                <div className="card">
                    ...
                    <div id="collapseThree" className="collapse" aria-labelledby="headingThree"
                         data-parent="#accordion">
                        <div className="card-body">
                            <GenericsTable items={CONTACTSCONTENT}/>
                        </div>
                    </div>
                </div>
            </div>
